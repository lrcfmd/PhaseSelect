...
if __name__ == '__main__':
    ...
    # =============== Training set
    phases = Phase2Vec('', load_phase_vectors='DATA/combined_mpds_scon_Tc.pkl', atomic_mode='embed')
    ...
    for i in range(ensemble_n):
        ...
        dtrain.to_csv(f"{dirname}/ranking_training_scon_single_run.csv")
        ...
        df.to_csv(f"{dirname}/ranking_scon_candidates_single_run.csv")
